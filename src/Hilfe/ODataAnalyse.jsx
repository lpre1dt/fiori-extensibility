...
export default function ODataAnalyse() {
  return (
    <div>
      ...
      <p>
        Zuerst müssen Sie den OData-Service ihrer Fiori-Anwendung identifzieren.
        Den Namen des OData-Service erhalten Sie aus der{" "}
        <Link
          target="_blank"
      ...
      <p>
        ...
        identifizieren. Es wird empfohlen den folgenden Entscheidungbaum zu
        durchlaufen und einem der Analyse-Profile zuzuordnen:
      </p>
      <Image src={"/ODataAnalyse.png"} />
      <Tabs defaultActiveKey="1">
        <Tabs.TabPane tab={<span>Analyse-Profil A</span>} key="1">
          ...
          <p>
            Durch die strenge Namenskonvention bei RAP OData Services, ist
            möglich, mit relativ geringen Aufwand, die Architektur des Services
        ...
        <Tabs.TabPane tab={<span>Analyse-Profil B</span>} key="2">
          ...
          <p>
            ...
            die mit „_CDS“ enden, kann die Endung „_CDS“ weggelassen werden und
            man erhält den Namen des Consumption CDS-Views, aus dem der
